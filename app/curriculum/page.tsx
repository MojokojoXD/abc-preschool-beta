...
export default function Curriculum()
{
  ...
  return (
    <div className='min-h-[calc(100vh-9rem)]'>
      <header className='h-[60vh] bg-[url("/curriculum-cover.jpg")] bg-cover bg-center bg-fixed bg-[0%_20%]'>
      ...
      <div className='px-10 sm:px-16 lg:px-24 xl:px-84 space-y-16 text-zinc-800' id='__3-4program'>
        <div className='bg-white py-28 px-5 shadow-sm'>
          <div className='grid grid-cols-2 auto-rows-min rounded-2xl overflow-hidden'>
            
            <div className='space-y-8 text-2xl bg-teal-400 py-14 px-12 row-span-2 border-t-8 border-b-4 border-s-8 border-e-4' id='__3-4'>
            ...
            <div className='overflow-hidden curriculum-segment bg-cover rounded-tr-3xl h-fit bg-center w-full border-t-8 border-b-4 border-e-8 border-s-4'>
              <Image src={ '/assets/curriculum/3-4_curriculum.webp' } alt='3 year olds playing' height={ 580 } width={ 660 } className='object-fit h-[440px]' />
            </div>
            <div className='space-y-8 text-2xl pt-14 pb-40 px-12 bg-primary/80 row-span-2 border-y-4 border-e-8 border-s-4' id='__4-5'>
            ...
            <div className='h-fit w-full overflow-hidden border-4 border-s-8'>
              <Image src={ '/assets/curriculum/4-5_curriculum.webp' } alt='3 year olds playing' height={ 580 } width={ 660 } className='object-fit h-[400px]' />
            </div>
            
            <div className='space-y-8 text-2xl bg-purple-300 py-14 px-12 rounded-b-3xl border-8 border-t-4 border-e-4'>
              ...
              <div className='space-y-4'>
                <h3 className='font-bold text-3xl'>3 & 4</h3>
              ...
              <div className='space-y-4'>
                <h3 className='font-bold text-3xl'>4 & 5</h3>
                <ul className='space-y-8 list-inside space-y-8'>
                  <li><CircleCheck className='inline mr-2.5' />Hee Haw Farms</li>
                  <li><CircleCheck className='inline mr-2.5' />Lehi Hutchings Museum</li>
            ...
            <div className='h-fit w-full rounded-br-3xl overflow-hidden bg-black/25 border-s-4 border-t-4 border-8'>
