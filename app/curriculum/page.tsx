...
export default function Curriculum()
{
  ...
  return (
    <div className='min-h-[calc(100vh-9rem)]'>
      <header className='h-[60vh] bg-[url("/curriculum-cover.jpg")] bg-cover bg-fixed bg-[0%_20%]'>
      ...
      <div className='px-10 sm:px-16 lg:px-24 xl:px-84 space-y-16 text-zinc-800' id='__3-4program'>
        <div className='bg-white'>
            <div className='grid grid-cols-2'>
              <div className='overflow-hidden h-fit w-full shadow'>
                <Image src={ '/3-year-old-program.jpg' } alt='3 year olds playing' height={ 580 } width={ 660 } className='object-fit' />
              </div>
              <div className='space-y-8 text-2xl bg-teal-400 unded-bl-3xl py-14 px-12'>
            ...
            <div className='grid grid-cols-2'>
              <div className='space-y-8 text-2xl py-14 px-12 shadow bg-primary/80'>
              ...
              <div className='h-fit w-full shadow'>
                <Image src={ '/4-year-old-program.jpg' } alt='3 year olds playing' height={ 580 } width={ 660 } className='object-fit' />
              </div>
            ...
            <div className='grid grid-cols-2'>
              ...
              <div className='space-y-8 text-2xl bg-purple-300 py-14 px-12'>
