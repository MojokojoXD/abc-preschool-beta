...
export default function Programs()
{
  ...
  return (
    <div>
      <header className='h-[22.5vh] sm:h-[60vh] bg-[url("/assets/programs/cover.webp")] bg-contain sm:bg-cover sm:bg-center bg-center bg-fixed sm:bg-[0%_20%]'>
        <div className='h-full bg-black/50 flex items-center justify-center sm:justify-start px-6 sm:px-16 lg:px-24 xl:px-84'>
