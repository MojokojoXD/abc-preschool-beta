      ...
      <CarouselContent >
        <CarouselItem  >
          <div className='relative h-[30rem] w-full rounded-[3rem] overflow-hidden'>
            <Image src={ '/home/carousel-1.webp' } alt='sensory table' fill className='object-cover' />
          </div>
        </CarouselItem>
        <CarouselItem  >
          <div className='relative h-[30rem] w-full rounded-[3rem] overflow-hidden'>
            <Image src={ '/home/carousel-2.webp' } alt='kids on a swing' fill className='object-cover' />
          </div>
        </CarouselItem>
        <CarouselItem  >
          <div className='relative h-[30rem] w-full rounded-[3rem] overflow-hidden'>
            <Image src={ '/home/carousel-3.jpg' } alt='kids playing outside' fill className='object-cover' />
          </div>
        </CarouselItem>
        <CarouselItem  >
          <div className='relative h-[30rem] w-full rounded-[3rem] overflow-hidden'>
            <Image src={ '/home/carousel-4.webp' } alt='kid mashing apple' fill className='object-cover' />
          </div>
        </CarouselItem>
        <CarouselItem  >
          <div className='relative h-[30rem] w-full rounded-[3rem] overflow-hidden'>
            <Image src={ '/home/carousel-5.webp' } alt='kid looking at worm' fill className='object-cover' />
          </div>
        </CarouselItem>
      </CarouselContent>
      <CarouselPrevious
